(() => {
    ...
    let father = document.querySelector(".popup__content");
    let rotate = document.querySelector(".popup__item-up");
    let rotateTwo = document.querySelector(".popup__item-in");
    rotate.addEventListener("click", (() => {
        father.classList.add("rotate");
        father.classList.remove("rotate-2");
    }));
    rotateTwo.addEventListener("click", (() => {
        father.classList.add("rotate-2");
